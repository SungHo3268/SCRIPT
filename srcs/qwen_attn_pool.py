...
class CustomQwen2Attention(nn.Module):
    ...
    def forward(
        ...
        before_pooled_states: torch.Tensor,
        ...
        **kwargs,
        ...
        key_states = self.k_proj(before_pooled_states)
        value_states = self.v_proj(before_pooled_states)
...
class CustomQwen2DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Self Attention --> (Customized) Cross Attnetion
