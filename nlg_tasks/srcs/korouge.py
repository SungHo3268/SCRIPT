...
class Rouge():
    ...
    def calc_score_L(self, candidate, refs):
        ...
        token_k = mecab.morphs(candidate)
...
#
#     cand_1 = "소년이 나무에서 사과를 따서 바구니에 넣는다."
#     cand_2 = "두 소녀가 나무에서 많은 빨간 사과를 따서 큰 가방에 넣는다."
#     ref = "소년이 나무에서 사과를 따서 가방에 넣는다."
#     concepts = ["따다", "사과", "나무", "넣다", "가방"]
#
#
#     rouge = Rouge()
#     print(rouge.calc_score_2(cand_2, ref))
#     print(rouge.calc_score_L(cand_2, ref))
